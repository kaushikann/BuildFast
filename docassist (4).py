...
if chapter_doc is not None:
    texts = ""
    reader = PdfReader(chapter_doc)
    temp_file = "./temp.pdf"
    with open(temp_file, "wb") as file:
       file.write(chapter_doc.getvalue())
       file_name = chapter_doc.name
    loader = PyPDFLoader(temp_file)
    documents = loader.load_and_split()

doc_split = text_splitter.split_text(documents)
