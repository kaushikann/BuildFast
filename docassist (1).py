...
doc_split = text_splitter.split_text(chapter_doc.read())
doc_embed = embeds.embed_documents(doc_split)
index_name="chapter"
vectorstore = PineconeVectorStore.from_documents(doc_split, doc_embed, index_name=index_name)
...
prmpt2_prompt = PromptTemplate(template = prmpt2_template, input_variables = ['result1', 'reult2', 'prmpt'])
